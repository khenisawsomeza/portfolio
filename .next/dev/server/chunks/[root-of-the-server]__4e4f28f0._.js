...
async function POST(request) {
    try {
        ...
        if (lastMessage.includes("about") || lastMessage.includes("who") || lastMessage.includes("introduce") || lastMessage.includes("tell me") || lastMessage.includes("background")) {
            ...
            response = "That's a great question! I can help with information about Khenyshi's skills, experience, projects, certificates, education, or contact details. For more specific information, you can also check out the relevant sections above or reach out directly via email at hinlogkhenyshi@gmail.com. What would you like to know?";
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "I'm having trouble processing that. Please try again or reach out via email at hinlogkhenyshi@gmail.com!"
        }, {
            status: 500
        });
    }
